...
<div class="wrap">
  ...
  <section class="ranking-section">
    ...
    <div class="trend-title-row"><h3>Last 30 days <span class="trend-note">(latest hour each day)</span></h3><span class="trend-note" id="t30Note"></span></div>
    <div class="chart-wrap" id="chart30"><div class="chart-loading">Loading trend…</div></div>
  </section>
